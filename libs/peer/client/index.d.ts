// Type definitions for the NxPeer class module
...
declare class Peer {
   ...
   */
  constructor(id?: string, options?: Peer.NxPeerOption);

  /**
   * A peer can connect to other peers and listen for connections.
   * @param options for specifying details about PeerServer
   */
  constructor(options: Peer.NxPeerOption);
