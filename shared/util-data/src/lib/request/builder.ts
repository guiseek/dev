...
export class RequestQueryBuilder {
  ...
  // setParamNames() {
  //   Object.keys(RequestQueryBuilder._options.paramNamesMap ?? {}).forEach(
  //     (key) => {
  //       if (
  //         RequestQueryBuilder._options.paramNamesMap &&
  //         key in RequestQueryBuilder._options.paramNamesMap
  //       ) {
  //         // const name =
  //         //   RequestQueryBuilder._options.paramNamesMap[
  //         //     key as keyof typeof RequestQueryBuilder._options.paramNamesMap
  //         //   ]
